...
- Extract and apply 3 different proposal approaches from the uploaded PDF by use the most relevant only one success story in 3 different approaches with different start in every of 3 generated proposalfor one job post
